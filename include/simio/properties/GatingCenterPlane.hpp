...
struct GatingCenterPlaneConfig {
    MoleculeSelection selection = MoleculeSelection::InChannelNow;
};

class GatingCenterPlaneProperty final : public layered::PropertyKernel {
  public:
    explicit GatingCenterPlaneProperty(const GatingCenterPlaneConfig& cfg = {});
